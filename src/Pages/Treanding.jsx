...
<h5 className='m-0 p-0 text-opacity-25'>Pyar Lona Pagal</h5>

<p className='m-0 p-0 mb-1' style={{fontWeight:"200"}}>Ravanasura | RaviTeja</p>
...
<p className='m-0 p-0 mb-1' style={{fontWeight:"200"}}>Dusshera | Nani</p>
